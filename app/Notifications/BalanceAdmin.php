...
class BalanceAdmin extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        $imgSrc = asset("assets/images/emails/transaction.png");

        $template->message = $this->replace_shortcode($template->message);
        $template->regards = ($template->regards == 'true' ? get_setting('site_mail_footer', "Best Regards, [[site_name]]") : '');
        ...
        return (new MailMessage)
                    ...
                    ->markdown('mail.transaction', compact('template', 'transaction','user', 'imgSrc'));
    }
