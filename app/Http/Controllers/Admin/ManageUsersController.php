...
class ManageUsersController extends Controller
{
    ...
    public function allUsers()
    {
        ...
        $users = User::select("id","firstname", "lastname", "email", "mobile", "username", "profile_photo_path", "status")->latest()->paginate(getPaginate(10));
    ...
    public function activeUsers()
    {
        ...
        $users = User::select("id","firstname", "lastname", "email", "mobile", "username", "profile_photo_path", "status")->active()->latest()->paginate(getPaginate(10));
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }

    public function disabledUsers()
    {
        $page_title = 'Manage Disabled Users';
        $empty_message = 'No disabled user found';
        $users = User::select("id","firstname", "lastname", "email", "mobile", "username", "profile_photo_path", "status")->onlyTrashed()->latest()->paginate(getPaginate(10));
        return view('admin.users.disabled', compact('page_title', 'empty_message', 'users'));
    }
    ...
    public function bannedUsers()
    {
        ...
        $users = User::banned()->latest()->paginate(getPaginate(10));
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    ...
    public function emailUnverifiedUsers()
    {
        ...
        $users = User::emailUnverified()->latest()->paginate(getPaginate(10));
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    public function emailVerifiedUsers()
    {
        ...
        $users = User::emailVerified()->latest()->paginate(getPaginate(10));
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    ...
    public function search(Request $request, $scope)
    {
        ...
        $users = $users->paginate(getPaginate(10));
    ...
    public function detail($id)
    {
        ...
        $refer_by = User::where('id', $user->invited_by)->first();
        ...
        //     $wallet_type = 'funding';
        // }
        return view('admin.users.detail', compact('page_title', 'user', 'totalDeposit', 'totalWithdraw','refer_by'));
    }
    ...
    {
        $user = User::findOrFail($id);
        $page_title = 'Referral Log : ' . $user->firstname.' '.$user->lastname;
        $empty_message = 'No Referral User Found';
        $users  = User::where('invited_by', $id)->latest()->paginate(getPaginate(10));
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    ...
    public function commissionLog($id)
    {
        ...
        $commissions = Commission::where('user_id', $id)->latest()->paginate(getPaginate(10));
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->merge(['role_id' => isset($request->role_id) ? 1 : 2]);
    ...
    public function userLoginHistory($id)
    {
        ...
        $login_logs = $user->login_logs()->latest()->paginate(getPaginate(10));
    ...
    public function transactions(Request $request, $id)
    {
        ...
        if ($request->search) {
            ...
            $transactions = $user->transactions()->where('trx', $search)->with('user')->latest()->paginate(getPaginate(10));
        ...
        $transactions = $user->transactions()->with('user')->latest()->paginate(getPaginate(10));
        $empty_message = 'No transactions';
    ...
    public function deposits(Request $request, $id)
    {
        ...
        if ($request->search) {
            ...
            $deposits = $user->deposits()->where('trx', $search)->latest()->paginate(getPaginate(10));
        ...
        $deposits = $user->deposits()->latest()->paginate(getPaginate(10));
        $empty_message = 'No deposits';
        $scope = 'all';
    ...
    public function enable($id)
    {
        ...
        $user->save();
        $notify[] = ['success', 'User has been enabled'];
        return redirect()->back()->withNotify($notify);
    }
}
