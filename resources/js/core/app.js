...
(function (window, document, $) {
    ...
    $(".custom-data-bs-table")
        ...
        .find(".card-search")
        .append(
            '<div class="input-group float-end border rounded"><input type="text" name="search_table" class="form-control bg-white border-0 border-end" placeholder="Search Table"><button class="btn btn-primary waves-effect waves-float waves-light" type="submit"><i class="bi bi-search"></i></button></div>'
        );
    $(".custom-data-bs-table")
        .closest(".card")
        .find(".card-body")
