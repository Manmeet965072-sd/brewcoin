                ...
                <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                        <div class="mb-1 col-md-6">
                            ...
                            <input type="text" name="firstname" id="firstname" class="form-control @error('firstname') is-invalid @enderror" placeholder="John" aria-describedby="register-firstname" tabindex="4" autofocus value="{{ old('firstname') }}" />
                            @error('firstname')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-1 col-md-6">
                            ...
                            <input type="text" name="lastname" id="lastname" class="form-control @error('lastname') is-invalid @enderror" placeholder="Doe" aria-describedby="register-lastname" tabindex="5" autofocus value="{{ old('lastname') }}" />
                            @error('lastname')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="row">
                        <div class="col-12 my-1">
                            ...
                            <input type="text" class="form-control" id="multiStepsreferenceBy" name="multiStepsreferBy" placeholder="johndoe" aria-describedby="referenceBy" tabindex="1" autofocus value="{{ session()->get('reference') }}" readonly />
                        </div>
                    </div>
                    @endif
