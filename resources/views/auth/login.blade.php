...
<div class="auth-wrapper auth-basic px-2">
    <div class="auth-inner my-2">
        ...
        <div class="card mb-0">
            <div class="card-body">
                <a href="{{ route('home') }}" class="col d-flex justify-content-center mb-1">
                    <div class="brand-text mb-2"><img src="{{ getImage(imagePath()['logoIcon']['path'] . '/logo.png') }}" class="img-fluid" width="220" alt="{{ __('locale.image') }}"></div>
                </a>
                ...
                <div class="auth-footer-btn d-flex justify-content-center">
                    <button type="button" class="btn btn-success w-100 walletConnectBtc" data-bs-toggle="modal" data-bs-target="#walletConnect">
                        Sign In With Wallet
                    </button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Wallet Connect</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div style="display: grid; grid-template-columns: 1fr 1fr;">
                    @if (!$detect->isMobile() && !$detect->isTablet())
                    <div onclick="login('Metamask')" style="align-items: center; display: flex; flex-direction: column; height: auto; justify-content: center; margin-left: auto; margin-right: auto; padding: 20px 5px; cursor: pointer;">
                        <img src="{{ asset('assets/images/wallets/metamaskWallet.png') }}" alt="Metamask" style="align-self: center; fill: rgb(40, 13, 95); flex-shrink: 0; margin-bottom: 8px; height: 30px;"><span class="ant-typography" style="font-size: 14px;">Metamask</span>
                    </div>
                    @endif
                    <div onclick="login('WalletConnect')" style="align-items: center; display: flex; flex-direction: column; height: auto; justify-content: center; margin-left: auto; margin-right: auto; padding: 20px 5px; cursor: pointer;">
                        <img src="{{ asset('assets/images/wallets/wallet-connect.svg') }}" alt="WalletConnect" style="align-self: center; fill: rgb(40, 13, 95); flex-shrink: 0; margin-bottom: 8px; height: 30px;"><span class="ant-typography" style="font-size: 14px;">WalletConnect</span>
                    </div>
                </div>
