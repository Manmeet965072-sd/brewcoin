...
@endphp
<div class="main-menu menu-fixed {{ $configData['theme'] === 'dark' || $configData['theme'] === 'semi-dark' ? 'menu-light' : 'menu-light' }} menu-accordion menu-shadow"
        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item me-auto">
                <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
                    ...
                    <div class="brand-text"><img src="{{ getImage(imagePath()['logoText']['path'] . '/logoText.png') }}"
