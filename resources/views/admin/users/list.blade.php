                    ...
                    <tbody>
                        @forelse($users as $user)
                            ...
                            <tr>
                                ...
                                data-bs-placement="top" title="{{ __('locale.Disable')}}">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ __('locale.Are you sure want to disable?')}}</h4>
            ...
            <form action="{{ route('admin.users.remove') }}" method="POST">
                ...
                <div class="modal-body py-2">
                    ...
                    <p><span class="fw-bold"></span> {{ __('locale.User will be disabled.')}}</p>
                </div>
