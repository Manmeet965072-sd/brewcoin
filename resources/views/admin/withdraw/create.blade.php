            ...
            <div class="card">
                <form action="{{ route('admin.withdraw.method.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border my-2">
                                            ...
                                            <h5 class="card-header bg-light py-1">@lang('Withdraw Instruction') </h5>
                                            <div class="card-body">
                                                <div class="col mt-1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border">
                                            <h5 class="card-header bg-light py-1 text-dark">{{ __('locale.User data')}}
                    ...
                    <div class="card-footer text-end">
                        <button type="submit" class="btn btn-primary">@lang('Save Method')</button>
                    </div>
                </form>
            </div><!-- card end -->
        </div>
