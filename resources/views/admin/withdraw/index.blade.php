...
<div class="row" id="table-hover-row">
    <!-- <div class="text-end mb-2" id="withdraw-add">
        <a href="{{ url('/admin/withdraw/create/') }}" class="btn btn-xs btn-info pull-right">Add +</a>
    </div> -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('Withdrawal Method Activation Confirmation')</h4>
    ...
    <div id="deactivateModal" class="modal fade text-start" tabindex="-1" aria-hidden="true" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('Withdrawal Method Disable Confirmation')</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
