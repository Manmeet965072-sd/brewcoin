                ...
                <div class="card-body">
                    ...
                    <div class="payment-method-item">
                        <div class="payment-method-header row">
                            <div class="col-lg-3">
                                <img class="img-thumbnail mb-1" src="{{getImage(imagePath()['withdraw']['method']['path'].'/'. $method->image,imagePath()['withdraw']['method']['size'])}}" />
                            ...
                            <div class="col-lg-9">
                                <div class="row mt-1">
                                    <div class="col-md-6">
                                        <label class="h6">{{ __('locale.Method Name')}} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="currency" class="form-control rounded" value="{{ $method->currency }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6">
                                        <label class="h6">@lang('Processing Time') <span class="text-danger">*</span></label>
                                        <input type="text" name="delay" class="form-control rounded" value="{{  $method->delay }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="card border">
                                        ...
                                        <h5 class="card-header bg-light text-dark">{{ __('locale.User data')}}
                                            <button type="button" class="btn btn-primary addUserData">
