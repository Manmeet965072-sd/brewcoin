                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Status">
                            <span class="dt-status-md badge badge-md badge-{{ __status($kyc->status,'status') }}">{{ __status($kyc->status,'text') }}</span>
                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.kyc.update') }}" method="POST" id="kyc_status_form" class="card-body p-2">
                ...
                <div class="modal-footer mt-1 p-0 justify-content-center">
