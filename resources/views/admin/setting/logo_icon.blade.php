            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6 mb-1">
                            <div class="img-fluid"
                                style="height:120px;background-size: cover;background-image: url({{ getImage(imagePath()['logoText']['path'] .'/logoText.png', '?'.time()) }})">
                                <button type="button" class="btn-icon btn-danger rounded"><i
                                        class="bi bi-x"></i></button>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="input-group input-group-merge">
                                <input class="form-control" type="file" id="profilePicUpload3" accept=".png"
                                    name="logo_text">
                                <label for="profilePicUpload3"
                                    class="input-group-text">{{ __('locale.Select Logo Text')}}</label>
                            </div>
                        </div>
                        <small class="ms-1 text-danger"><code>350px x 75px</code></small>
                    </div>
