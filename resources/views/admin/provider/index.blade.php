...
@section('content')
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-hover custom-data-bs-table">
                        ...
                        <tbody>
                            @forelse($providers->take(3) as $provider)
                                <tr>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{ __('locale.Provider Activation Confirmation') }}</h4>
    ...
    <div id="deactivateModal" class="modal fade text-start" tabindex="-1" aria-hidden="true" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{ __('locale.Provider Deactivation Confirmation') }}</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
